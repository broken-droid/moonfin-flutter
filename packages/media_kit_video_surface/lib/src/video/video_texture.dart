      ...
      child: ValueListenableBuilder<VideoViewParameters>(
        ...
        builder: (context, videoViewParameters, _) {
          return Container(
            ...
            color: Platform.isAndroid ? Colors.transparent : videoViewParameters.fill,
            child: Stack(
              fit: StackFit.expand,
              children: [
                ClipRect(
                  child: FittedBox(
                    ...
                    child: ValueListenableBuilder<PlatformVideoController?>(
                      ...
                      builder: (context, notifier, _) => notifier == null
                          ...
                          : Platform.isAndroid
                              ? const _AndroidSurfaceViewVideo()
...
class _AndroidSurfaceViewVideo extends StatefulWidget {
  const _AndroidSurfaceViewVideo();

  @override
  State<_AndroidSurfaceViewVideo> createState() =>
      _AndroidSurfaceViewVideoState();
}

class _AndroidSurfaceViewVideoState extends State<_AndroidSurfaceViewVideo> {
  @override
  Widget build(BuildContext context) {
